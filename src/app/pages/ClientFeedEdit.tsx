...
export function ClientFeedEdit() {
  ...
  const loadFeed = async () => {
    try {
      setLoading(true);
      setError(null);
      const feed = await apiClient.getFeedById(id!);
      ...
      setFormData({
        ...
        cover_image_url:
          feed.resources?.find((r) => r.name === "cover_image")?.url || "",
      });
    } catch (err: any) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await apiClient.updateClientFeed(id!, {
      ...
      navigate("/feeds/published");
    } catch (err: any) {
      setError(err.message || "Failed to save feed");
      alert(err.message || "Failed to save feed");
    } finally {
      setSaving(false);
    }
  };
    ...
    return (
      <div className="p-6 flex items-center justify-center min-h-screen">
        <div className="text-center">
          ...
          <p className="text-sm text-gray-500 mt-3">Loading feed...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="mb-5 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-gray-900">Edit Published Feed</h1>
            <p className="text-sm text-gray-500 mt-0.5">
              Update feed visible to users
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
              ...
              <div className="bg-gray-100 border-b border-gray-200 px-5 py-2 flex items-center gap-2">
                ...
                <span className="text-xs text-gray-500 ml-2">Feed Editor</span>
              </div>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      placeholder="Enter feed HTML content"
                    />
                  </div>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    ...
                    >
                      ...
                      <option value="photoDominant">Photo Dominant</option>
                      <option value="textDominant">Text Dominant</option>
